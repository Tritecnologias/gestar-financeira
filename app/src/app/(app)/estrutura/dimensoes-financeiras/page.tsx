...
export const metadata: Metadata = { title: 'Dimensões Financeiras – Gestar Financeira' };
  ...
  return (
    <div>
      ...
      <div style={{ padding: '60px 28px', textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Dimensões Financeiras</div>
